 ...
 10.times { |index| Album.create( artist_id: rand(1..10) , title: Faker::Lorem.sentence(word_count: 6)  ) } 
 10.times { |index| Invoice.create( customer_id: rand(1..10) , invoice_date: rand(1..10) , total: rand(1..10)  ) } 
 10.times { |index| Track.create( album_id: rand(1..10) , genre_id: rand(1..10) , media_type_id: rand(1..10) , name: Faker::Name.unique.name , composer: Faker::Lorem.sentence(word_count: 3) , miliseconds: rand(1..10) , bytes: rand(1..10) , unit_price: rand(1..10)  ) } 
